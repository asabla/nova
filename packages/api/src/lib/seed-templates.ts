...
// ---------------------------------------------------------------------------
// All 62 explore templates (extracted from packages/web/src/routes/_auth/explore.tsx)
// ---------------------------------------------------------------------------
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. how TLS/SSL encryption works, how garbage collection works, how DNS resolution works...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "Paste your raw meeting notes, transcript, or brain dump here...",
        required: true,
      },
      {
        id: "notes_file",
        ...
        required: false,
        accept:
          ".txt,.md,.docx,.pdf,text/plain,text/markdown,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf",
      },
    ],
  },
  {
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Our CI/CD pipeline takes 45 minutes and we need it under 15, our onboarding flow has a 60% drop-off rate, we're running out of database storage...",
        required: true,
      },
    ],
  },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        required: false,
        accept:
          "text/*,application/json,.ts,.tsx,.js,.jsx,.py,.go,.rs,.java,.rb,.php,.swift,.kt",
      },
    ],
  },
  {
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. A real-time notification system for a SaaS app with 100k daily active users, supporting push notifications, in-app, and email digests...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Monitor a directory for new CSV files, validate their schema, clean the data, and load them into a SQLite database...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. React Native vs Flutter vs native Swift/Kotlin for a mobile app. Our team knows TypeScript well. We need offline support and push notifications...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. WebAssembly for server-side use, edge computing architectures, vector databases...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Announce to the engineering team that we're migrating from REST to GraphQL. Tone: direct but encouraging. Include timeline and a clear ask to review the RFC by Friday...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Adopting a design system at our 40-person startup. We have 3 frontend apps with inconsistent UI. We want to propose a component library + design tokens + Storybook...",
        required: true,
      },
    ],
  },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        required: false,
        accept:
          ".csv,.xlsx,.xls,.json,.tsv,text/csv,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/json",
      },
    ],
  },
  {
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Find all customers who made at least 3 purchases in the last 90 days but haven't logged in during the last 14 days...",
        required: true,
      },
      {
        id: "schema",
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Competitive analysis of the self-hosted AI platform market — compare open-source, commercial self-hosted, and cloud-managed options for a 50-person team...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Q1 2026 company results — revenue growth, new customers, product launches, team growth, Q2 priorities...",
        required: true,
      },
      {
        id: "topic_file",
      ...
      },
      {
        ...
        placeholder:
          "e.g. Executive leadership, board of directors, all-hands meeting...",
        required: true,
      },
    ],
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        placeholder:
          "e.g. SaaS billing platform, enterprise plan, customer since 2024...",
        required: false,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        label: "Type of memo",
        placeholder:
          "e.g. Policy change, org restructure, post-mortem, product launch announcement...",
        required: true,
      },
      {
        id: "details",
        ...
        placeholder:
          "What happened, what's changing, why, and what people need to do...",
        required: true,
      },
      {
        id: "audience",
        ...
        placeholder:
          "e.g. Engineering team, all employees, leadership team...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. AI-powered customer support platform, developer productivity tool...",
        required: true,
      },
      {
        id: "prospect",
        ...
        placeholder:
          "e.g. VP of Engineering at a 200-person fintech company. They recently posted about scaling challenges on LinkedIn...",
        required: true,
      },
      {
        id: "value_prop",
        ...
        placeholder:
          "e.g. Reduce support ticket resolution time by 60%...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        label: "Meeting type",
        placeholder:
          "e.g. Sprint planning, quarterly review, 1:1, project kickoff...",
        required: true,
      },
      {
        id: "duration",
      ...
      },
      {
        ...
        placeholder:
          "e.g. Engineering team (8 people), cross-functional leads...",
        required: false,
      },
      {
        id: "topics",
        ...
        placeholder:
          "1. Status update on migration project\n2. Decide on new hire priority\n3. Review Q2 roadmap\n4. Open discussion",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        label: "Job title",
        placeholder:
          "e.g. Senior Backend Engineer, Product Design Lead, DevOps Manager...",
        required: true,
      },
      {
        id: "company",
        ...
        placeholder:
          "e.g. Series B developer tools startup, 60 people, remote-first, building a cloud IDE. Stack: Go, React, Kubernetes...",
        required: true,
      },
      {
        id: "responsibilities",
        ...
        placeholder:
          "Own the authentication and authorization system, mentor 2 junior engineers, 5+ years backend experience, strong in distributed systems...",
        required: true,
      },
    ],
  },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        required: false,
        accept:
          ".pdf,.docx,.txt,.md,.pptx,application/pdf,application/vnd.openxmlformats-officedocument.wordprocessingml.document,text/plain,text/markdown",
      },
    ],
  },
  {
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Migrate our monolithic Rails app to microservices. Currently serving 50k RPM. Need to maintain uptime during migration...",
        required: true,
      },
      {
        id: "timeline",
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. All tables with financial data, contact information from each page, the terms and conditions section, all dates and amounts...",
        required: true,
      },
      {
        id: "content_file",
    ...
    inputs: [
      {
        ...
        label: "Diagram type",
        placeholder:
          "e.g. flowchart, architecture diagram, sequence diagram, ERD, mind map, org chart...",
        required: true,
      },
      {
        id: "description",
        ...
        placeholder:
          "e.g. User authentication flow — from login page through OAuth, MFA verification, session creation, and redirect to dashboard...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. An open-source project management tool for remote teams. Key features: async standups, time zone-aware scheduling, GitHub integration...",
        required: true,
      },
      {
        id: "audience",
        ...
        label: "Target audience",
        placeholder:
          "e.g. Engineering managers at mid-size startups...",
        required: true,
      },
      {
        id: "style",
        ...
        placeholder:
          "e.g. Minimalist, bold and colorful, dark mode, editorial, retro...",
        required: false,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. A health and wellness app, a developer tools brand, a luxury e-commerce site...",
        required: true,
      },
      {
        id: "mood",
        ...
        label: "Mood or vibe",
        placeholder:
          "e.g. Calm and trustworthy, energetic and playful, premium and sophisticated...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. The visual rhythm of ocean waves, neural network connections as organic forms, the geometry of city grids from above...",
        required: true,
      },
      {
        id: "style",
        ...
        placeholder:
          "e.g. Monochrome, watercolor feel, geometric, particle-based, organic...",
        required: false,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. A mortgage calculator with amortization schedule chart, a Pomodoro timer with task tracking, a color contrast checker for accessibility...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        label: "Quiz topic",
        placeholder:
          "e.g. JavaScript closures, American Civil War, organic chemistry, machine learning fundamentals...",
        required: true,
      },
      {
        id: "audience",
        ...
        label: "Target audience",
        placeholder:
          "e.g. College freshmen, senior developers, high school students...",
        required: true,
      },
      {
        id: "difficulty",
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Calculus II integrals, AWS Solutions Architect exam, constitutional law, data structures...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        label: "What concept?",
        placeholder:
          "e.g. Blockchain, quantum computing, CRISPR gene editing, how the stock market works...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Introduction to recursion in Python, World War II causes, photosynthesis, financial literacy for teens...",
        required: true,
      },
      {
        id: "duration",
      ...
      },
      {
        ...
        placeholder:
          "e.g. High school sophomores, bootcamp students, university freshmen...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "Describe the spreadsheet contents, paste sample data, or just say 'general analysis'...",
        required: true,
      },
      {
        id: "content_file",
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. SaaS startup with $50/mo plan, 10% monthly growth, 3% churn. Current: 200 customers. Model 24 months forward...",
        required: true,
      },
      {
        id: "assumptions",
        ...
        placeholder:
          "e.g. CAC: $200, LTV target: 3x CAC, gross margin: 80%, team grows from 5 to 15 over 12 months, avg salary $120k...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Email addresses, US phone numbers in any format, URLs with optional www and port, ISO dates with optional time...",
        required: true,
      },
      {
        id: "examples",
        ...
        placeholder:
          "Match: user@example.com, test.name+tag@domain.co.uk\nDon't match: @invalid, user@, plaintext",
        required: false,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "Paste your API routes, controller code, or endpoint definitions...",
        required: true,
      },
      {
        id: "code_file",
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. A multi-tenant SaaS app with users, organizations, projects, tasks, comments, file attachments, and an audit log. Users can belong to multiple orgs with different roles...",
        required: true,
      },
      {
        id: "database",
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. README, getting started guide, runbook, ADR, API reference, troubleshooting guide...",
        required: true,
      },
      {
        id: "subject",
        ...
        placeholder:
          "e.g. Our internal deployment pipeline — deploys to staging via PR merge, production via release tag. Uses Terraform + Kubernetes + ArgoCD...",
        required: true,
      },
      {
        id: "reader",
        ...
        label: "Target reader",
        placeholder:
          "e.g. New engineer on the team, external API consumer, on-call engineer...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Why we migrated from microservices back to a monolith — the hidden costs of distributed systems at our scale (20 engineers, 50k users)...",
        required: true,
      },
      {
        id: "audience",
        ...
        label: "Target audience",
        placeholder:
          "e.g. Senior engineers, startup founders, product managers...",
        required: true,
      },
      {
        id: "tone",
        ...
        label: "Tone (optional)",
        placeholder:
          "e.g. Technical but approachable, opinionated, conversational, formal...",
        required: false,
      },
      {
        id: "length",
        ...
        placeholder:
          "e.g. 1500 words, short (500 words), long-form (3000+ words)...",
        required: false,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Add team-based permissions to our SaaS app. Users should be able to create teams, invite members with roles (admin/member/viewer), and restrict project access by team...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. 90% of startups fail within the first 5 years, TypeScript adds 30% to development time, GPT-4 passed the bar exam in the 90th percentile...",
        required: true,
      },
      {
        id: "context",
        ...
        placeholder:
          "e.g. A blog post about startup metrics, a conference talk, a tweet...",
        required: false,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. An AI-powered tool that auto-generates compliance documentation for fintech startups. Target: Series A-C fintechs in the US and EU dealing with SOX, PCI-DSS, and GDPR requirements...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. Should I accept a higher-paying job at a big company vs. stay at my current startup?",
        required: true,
      },
      {
        id: "context",
        ...
        placeholder:
          "e.g. Current startup: 20 people, I'm employee #5, 1.5% equity, below-market salary. New offer: 40% raise, RSUs, but 500-person company. I value autonomy and learning but have a mortgage...",
        required: true,
      },
    ],
  },
    ...
    inputs: [
      {
        ...
        placeholder:
          "e.g. worked on the auth migration most of the day, PR is up but needs review from Sarah. Today I'll start on the billing API but waiting on the Stripe webhook docs from Mike. Also fixed that flaky test in CI...",
        required: true,
      },
    ],
  },
...
export async function seedExploreTemplates(orgId: string, userId: string): Promise<void> {
  const now = new Date();
