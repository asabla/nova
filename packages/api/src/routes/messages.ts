...
messagesRouter.post("/:conversationId/messages/stream", zValidator("json", streamSchema), async (c) => {
  ...
  const formattingInstruction = {
    ...
    content: [
      ...
      '- Dice (random roller): ```widget\n{"type":"dice","title":"D20 Roller","params":{"type":"d20","count":"2"}}\n```',
      ...
      "- DICE: Use for random generation, games, or decision-making. type: 'd6', 'd20', 'coin', or 'custom'. count is number of dice.",
      ...
      "- CURRENCY: Use when asked about exchange rates or currency conversion. Fetches live rates automatically.",
      "- STOCK: Use when discussing stocks. You must provide the data in params (price, change, sparkline) — the widget does NOT fetch data.",
