...
export function MessageInput({ onSend, onStop, isStreaming, disabled, onFileUpload }: MessageInputProps) {
      ...
      <div className="max-w-3xl mx-auto">
        <div className="flex items-end gap-2 rounded-2xl border border-border bg-surface-secondary px-3 py-2 focus-within:border-primary/50 transition-colors">
          ...
          {isStreaming ? (
            <button
              onClick={onStop}
              className="p-2 rounded-xl bg-danger text-primary-foreground hover:bg-danger/90 transition-colors shrink-0 mb-0.5"
              title="Stop"
            >
