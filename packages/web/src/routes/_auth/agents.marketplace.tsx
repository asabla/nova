...
import { Bot, Search, Plus, Users, Zap, Copy, ArrowRight, RefreshCw } from "lucide-react";
    ...
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-text mb-2">{t("marketplace.title", "Agent Marketplace")}</h1>
          <p className="text-sm text-text-secondary max-w-md mx-auto">
            {t("marketplace.description", "Browse published agents from your organization. Clone any agent to customize it for your needs.")}
          </p>
        </div>
            ...
            {agentList.map((agent: any) => (
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {t("marketplace.view", "View")} <ArrowRight className="h-3 w-3" aria-hidden="true" />
                  </button>
                  <button
                  ...
                  >
                    <Copy className="h-3 w-3" aria-hidden="true" /> {t("marketplace.clone", "Clone")}
                  </button>
                </div>
              </div>
            ))}
