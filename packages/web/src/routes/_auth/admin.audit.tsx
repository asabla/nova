        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-surface-secondary text-text-secondary text-xs">
              <th className="text-left px-4 py-2 font-medium">{t("admin.time", { defaultValue: "Time" })}</th>
              <th className="text-left px-4 py-2 font-medium">{t("admin.actor", { defaultValue: "Actor" })}</th>
              <th className="text-left px-4 py-2 font-medium">{t("admin.action", { defaultValue: "Action" })}</th>
              <th className="text-left px-4 py-2 font-medium">{t("admin.resource", { defaultValue: "Resource" })}</th>
              <th className="text-left px-4 py-2 font-medium">{t("admin.details", { defaultValue: "Details" })}</th>
            </tr>
          </thead>
          <tbody>
            {isLoading ? (
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between text-sm">
          <span className="text-xs text-text-tertiary">
            {t("admin.pageOf", { defaultValue: "Page {{page}} of {{total}}", page, total: totalPages })}
          </span>
