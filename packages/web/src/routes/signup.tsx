    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-2 mb-6">
          <button
            onClick={() => { window.location.href = `${import.meta.env.VITE_API_URL ?? ""}/api/sso/microsoft/authorize`; }}
          ...
          <button
            onClick={() => { window.location.href = `${import.meta.env.VITE_API_URL ?? ""}/api/sso/google/authorize`; }}
            className="w-full flex items-center justify-center gap-2 h-10 rounded-lg border border-border bg-surface text-sm text-text hover:bg-surface-secondary transition-colors"
          >
          ...
          <button
            onClick={() => { window.location.href = `${import.meta.env.VITE_API_URL ?? ""}/api/sso/github/authorize`; }}
            className="w-full flex items-center justify-center gap-2 h-10 rounded-lg border border-border bg-surface text-sm text-text hover:bg-surface-secondary transition-colors"
          >
